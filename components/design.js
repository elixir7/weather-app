  ...
  render() {
    return (
      <div>
        ...
        <p>I decided I wanted to create the web app with an interesting design and challenge myself to work with someone else's design. I did some searching over at <a href="https://dribbble.com/search?q=weather+app" target="_blank">dribble.com</a> and found some interesting designs. After deciding which one I liked the most i contacted the <a href="https://dribbble.com/Marina_Matijaca" target="_blank">creator</a>. I asked if I could use her designs in my app. She said yes and gave me the source files. I tweaked the deign a little bit to fit what I was going to create. Big thanks to Marina for letting me use her work!</p>
