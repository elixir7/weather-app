  ...
  render() {
    return (
      <div>
        ...
        <p>The weather application and the website was created using only Java Script with the help of a lot of new technologies, best practices and libraries. I wanted to improve my Java Script knowledge and really push myself with this project. Big shoutout to <a href="https://github.com/edvinerikson" target="_blank">Edvin Erikson</a> for helping me throughout the project!</p>
        ...
        <p><a href="https://webpack.github.io/" target="_blank">Express</a> is a modular bundler that can runs your code through a bunch of transpilers/loaders and spits out a single, big file for you to use. With the help of webpack we can also reduce the number of HTTP requests to the server. We can also write some amazing java script called ES6(ecma script 6) which is the next generetion of java script. All ES6 features are not supported by all browser but webpack can transpile your ES6 code to regualr ES5 java script which all browsers understand. Amazing huh?</p>

        <p><a href="http://expressjs.com/" target="_blank">Express</a> is a library that sets up a server. The server serves the files to your machine when you give it a request</p>
